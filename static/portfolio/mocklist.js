...
MockList.URL_GETID = '/portfolio/api/getid/';
MockList.URL_FILE_UPLOAD = '/portfolio/api/savemock/';
MockList.URL_FILE_DELETE = '/portfolio/api/deletemock/';
MockList.URL_SAVE = '/portfolio/api/savemocklist/';
MockList.URL_MOCK = '/portfolio/i'; // no trailing slash
MockList.URL_VIEWER_BASE = '/portfolio/m'; // no trailing slash
MockList.URL_DELETE_MOCKLIST = '/portfolio/api/deletemocklist/';
MockList.URL_MANUAL_UPLOAD = '/portfolio/api/manualupload/';
